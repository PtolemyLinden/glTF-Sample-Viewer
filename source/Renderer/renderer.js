...
//console.info( "# Lights: ", this.visibleLights.length );
        ...
        let debugOutputMapping = [
            ...
            {debugOutput: GltfState.DebugOutput.misc.DIFFUSE_C           , shaderDefine: "DEBUG_DIFFUSE_C"           },
            {debugOutput: GltfState.DebugOutput.misc.DIFFUSE_FINAL       , shaderDefine: "DEBUG_DIFFUSE_FINAL"       },
            {debugOutput: GltfState.DebugOutput.misc.DIFFUSE_IBL         , shaderDefine: "DEBUG_DIFFUSE_IBL"         },
            ...
            {debugOutput: GltfState.DebugOutput.misc.DIFFUSE_REFLECT0    , shaderDefine: "DEBUG_DIFFUSE_REFLECT0"    },
            ...
            {debugOutput: GltfState.DebugOutput.misc.EMS                 , shaderDefine: "DEBUG_EMS"                 },
            {debugOutput: GltfState.DebugOutput.misc.F_AVG               , shaderDefine: "DEBUG_F_AVG"               },
            {debugOutput: GltfState.DebugOutput.misc.FMS_EMS_AVG         , shaderDefine: "DEBUG_FMS_EMS_AVG"         },
            ...
            {debugOutput: GltfState.DebugOutput.misc.SPEC_NORMAL_MAP     , shaderDefine: "DEBUG_SPEC_NORMAL_MAP"     },
            {debugOutput: GltfState.DebugOutput.misc.SPEC_NORMAL_GEOM    , shaderDefine: "DEBUG_SPEC_NORMAL_GEOM"    },
            {debugOutput: GltfState.DebugOutput.misc.SPEC_REFLECTION     , shaderDefine: "DEBUG_SPEC_REFLECTION"     },
            {debugOutput: GltfState.DebugOutput.misc.SPEC_FINAL          , shaderDefine: "DEBUG_SPEC_FINAL"          },
            {debugOutput: GltfState.DebugOutput.misc.SPEC_IBL            , shaderDefine: "DEBUG_SPEC_IBL"            },
            ...
            {debugOutput: GltfState.DebugOutput.punctual.H                , shaderDefine: "DEBUG_PUNCTUAL_H"                 },
            {debugOutput: GltfState.DebugOutput.punctual.L                , shaderDefine: "DEBUG_PUNCTUAL_L"                 },
            {debugOutput: GltfState.DebugOutput.punctual.N_DOT_H          , shaderDefine: "DEBUG_PUNCTUAL_N_DOT_H"           },
            {debugOutput: GltfState.DebugOutput.punctual.N_DOT_L          , shaderDefine: "DEBUG_PUNCTUAL_N_DOT_L"           },
            {debugOutput: GltfState.DebugOutput.punctual.N_DOT_V          , shaderDefine: "DEBUG_PUNCTUAL_N_DOT_V"           },
            {debugOutput: GltfState.DebugOutput.punctual.V_DOT_H          , shaderDefine: "DEBUG_PUNCTUAL_V_DOT_H"           },
            {debugOutput: GltfState.DebugOutput.punctual.INTENSITY        , shaderDefine: "DEBUG_PUNCTUAL_INTENSITY"         },
            {debugOutput: GltfState.DebugOutput.punctual.INTENSITY_N_DOT_L, shaderDefine: "DEBUG_PUNCTUAL_INTENSITY_N_DOT_L" },
            {debugOutput: GltfState.DebugOutput.punctual.BRDF_DIFFUSE     , shaderDefine: "DEBUG_PUNCTUAL_BRDF_DIFFUSE"      },
            {debugOutput: GltfState.DebugOutput.punctual.BRDF_SPECULAR    , shaderDefine: "DEBUG_PUNCTUAL_BRDF_SPECULAR"     },
            {debugOutput: GltfState.DebugOutput.punctual.DIFFUSE          , shaderDefine: "DEBUG_PUNCTUAL_DIFFUSE"           },
            {debugOutput: GltfState.DebugOutput.punctual.SPECULAR         , shaderDefine: "DEBUG_PUNCTUAL_SPECULAR"          },
